...
import PublicPasswordProtection from './components/PublicPasswordProtection';
...
const PublicApp: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const authenticated = sessionStorage.getItem('wedding_public_authenticated');
        ...
        <main className="min-h-screen relative bg-transparent overflow-x-hidden" style={{ touchAction: 'pan-y pinch-zoom', overscrollBehaviorX: 'none' }}>
            <AnimatePresence mode="wait">
                {!isAuthenticated ? (
                    ...
                    >
                        <PublicPasswordProtection onAuthenticated={handleAuthenticated} />
                    </motion.div>
                ) : !showContent ? (
                    <motion.div
                        key="intro"
                    ...
                    >
                        <InvitationContent colorMode={isColorVersion} isPublic={true} />
                    </motion.div>
                )}
            </AnimatePresence>
