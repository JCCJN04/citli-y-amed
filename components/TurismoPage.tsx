  ...
  return (
    ...
    >
      ...
      <div className="pt-20 pb-12">
        ...
        {/* ========================================== */}
        <section id="viajar-tepic" className="py-16 px-6">
        ...
        {/* SECCIÓN 2: HOTELES */}
        {/* ========================================== */}
        <section id="hoteles" className="py-24 px-6 max-w-3xl mx-auto">
        ...
        {/* ========================================== */}
        <section id="estilistas" className="py-24 px-6">
        ...
        {/* ========================================== */}
        <section id="turismo-nayarit" className="py-24 px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mb-24">
              ...
              <div className="space-y-3 mb-16">
                <motion.div {...fadeInUp} className="flex items-center justify-between pb-2">
            ...
            <div className="mb-16 pt-12 border-t-2 border-[#c9a69a]">
              <h2 className="font-script text-5xl md:text-6xl text-stone-800 mb-12 text-center">Recomendaciones Rápidas</h2>
        ...
        <section id="gastronomia" className="py-24 px-6">
          <div className="max-w-5xl mx-auto">
            ...
            {/* A) SAZÓN */}
            <div className="mb-24">
              <h3 className="font-breathing text-3xl text-[#5f6d4f] mb-12">
                Sazón
              </h3>
              ...
              <div className="mb-16 relative">
                <div className="absolute left-0 top-0 h-full flex items-center justify-center" style={{ width: '20px' }}>
                  <h4 className="font-breathing text-base text-[#5f6d4f] opacity-80 whitespace-nowrap" style={{ transform: 'rotate(-90deg)', transformOrigin: 'center' }}>
                    Desayunos
                  </h4>
                </div>
                <div className="ml-16 space-y-3">
