...
const InvitationContent: React.FC<InvitationContentProps> = ({ colorMode = true, isPublic = false }) => {
      ...
      <div className="w-full min-h-screen font-serif-elegant selection:bg-[#e8e0d8]/40 relative bg-transparent">
          ...
          >
            <div className="space-y-1 mb-6">
              <p className="text-xl md:text-4xl font-script text-[#2B2B2B] leading-tight text-center md:text-left px-0 md:px-2 md:whitespace-nowrap">
                {isPublic ? 'Nombre de la Novia' : 'Citli Daniela'}
              </p>
              ...
              <p className="text-xl md:text-4xl font-script text-[#2B2B2B] leading-tight text-center md:text-right px-0 md:px-2 md:whitespace-nowrap">
                {isPublic ? 'Nombre del Novio' : 'Amed Francisco'}
              </p>
            </div>
        ...
        <section className="py-16 px-6 flex flex-col items-center text-center relative overflow-hidden border-y border-stone-200/50">
          ...
          <motion.div {...fadeInUp} className="space-y-12 z-10 relative max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-20 relative">
              ...
              <div className="flex flex-col items-center">
                <p className="font-alice text-lg md:text-xl text-[#5f6d4f] leading-relaxed">{isPublic ? 'Nombre del Padre' : 'Luis Armando Rios Magallanes'}</p>
                <p className="font-alice text-2xl md:text-3xl text-[#5f6d4f] my-2">&</p>
                <p className="font-alice text-lg md:text-xl text-[#5f6d4f] leading-relaxed">{isPublic ? 'Nombre de la Madre' : 'Karla Esther González Cedano'}</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                <p className="font-alice text-lg md:text-xl text-[#5f6d4f] leading-relaxed">{isPublic ? 'Nombre del Padre' : 'Víctor Hugo Hernández de los Santos'}</p>
                <p className="font-alice text-2xl md:text-3xl text-[#5f6d4f] my-2">&</p>
                <p className="font-alice text-lg md:text-xl text-[#5f6d4f] leading-relaxed">{isPublic ? 'Nombre de la Madre' : 'Margarita Araceli Miranda de Santiago'}</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex justify-between z-[1] relative">
              <div className="grid gap-2">
                ...
                <p className="m-0 text-base tracking-[1.5px] font-bold max-w-[232px] whitespace-nowrap overflow-hidden text-ellipsis" style={{ textShadow: '0 0px 8px rgba(0, 0, 0, 0.12)' }}>
                  {isPublic ? '••••••••••••••••••' : '002180700905308698'}
                </p>
                <p className="m-0 text-[10px] uppercase font-medium tracking-[1.5px]">
                  Titular
                </p>
                <p className="m-0 text-sm tracking-[1.5px] font-bold leading-tight" style={{ textShadow: '0 0px 8px rgba(0, 0, 0, 0.12)' }}>
                  {isPublic ? 'Nombre del Titular' : 'Amed Francisco Hernández Miranda'}
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <section id="rsvp" className="py-20 px-6 flex flex-col items-center">
          <motion.div {...fadeInUp} className="w-full max-w-xl flex flex-col items-center">
            ...
            {isPublic ? (
              <div className="w-full bg-white/60 backdrop-blur-sm rounded-lg border border-stone-200 p-12 mb-12 text-center">
                <p className="font-serif-elegant text-lg text-stone-600 mb-4">Formulario de confirmación</p>
                <p className="font-serif-elegant text-sm text-stone-400 italic">No disponible en la vista previa</p>
              </div>
            ) : (
